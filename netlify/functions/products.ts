...
const DEFAULT_PRODUCTS = [
  ...
  { id: 1782138955561, title: "dis", category: "Suits", price: 2, originalPrice: null, rating: 4.7, reviews: 0, color: "charcoal", size: "M", popularity: 80, icon: "🕴️", iconBg: "linear-gradient(135deg,#2d2a26,#4a4540)", description: "434", image: null },
];
